...
export const proyectos = [
  {
    ...
    cliente: "Producto propio TecnoIngeniería B.O.",
    descripcion:
  ...
  },
  {
    ...
    cliente: "Empresa del sector logístico (confidencial)",
    descripcion:
  ...
  },
  {
    ...
    cliente: "Firmas de contabilidad",
    descripcion:
    ...
    resultado:
      "Nació como solución a la medida para la firma Villarreal-Romero y hoy opera como plataforma compartida por dos firmas contables, con roles jerárquicos, borrado lógico para auditoría y cálculo automático de obligaciones por cliente.",
  },
];
...
export const equipo = [
  {
    ...
    descripcion:
      "Especialistas en arquitectura de software, bases de datos y APIs.",
  },
  {
    nombre: "Equipo de Infraestructura",
    rol: "Redes & Soporte",
    descripcion:
      "Técnicos certificados en instalación y mantenimiento de redes.",
  },
  {
