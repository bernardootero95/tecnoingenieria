...
export const procesoTrabajo = [
  {
    ...
    titulo: "Diagnóstico",
    descripcion:
      "Conversamos sobre lo que necesitas y evaluamos si podemos ayudarte, con un diagnóstico inicial gratuito y sin compromiso.",
  },
  {
    paso: 2,
    titulo: "Cotización",
    descripcion:
      "Te damos una propuesta clara de alcance y costo antes de empezar, sin sorpresas en el camino.",
  },
  {
    paso: 3,
    titulo: "Implementación",
    descripcion:
      "Desarrollamos e implementamos la solución acordada, adaptada a cómo trabaja tu empresa.",
  },
  {
    paso: 4,
    titulo: "Soporte continuo",
    descripcion:
      "Una vez el sistema está funcionando, seguimos acompañándote con soporte continuo.",
  },
];
