...
const valores = [
  {
    titulo: "Precisión",
    descripcion:
      "Cada línea de código y cada cable importa. Trabajamos con detalle técnico riguroso.",
  },
  {
    titulo: "Compromiso",
    descripcion:
      "Tu proyecto es nuestro proyecto. Estamos desde el inicio hasta que funciona perfecto.",
  },
  {
    titulo: "Innovación",
    descripcion:
      "Adoptamos las mejores tecnologías del mercado para que siempre estés un paso adelante.",
  },
  {
    titulo: "Transparencia",
    descripcion:
      "Comunicación clara en cada etapa: avances, costos y decisiones siempre contigo.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed text-lg mb-4">
                TecnoIngeniería B.O. nació con la visión de cerrar la brecha
                tecnológica que existe entre las grandes ciudades y los
                municipios del Caribe colombiano. Desde Ciénaga, Magdalena,
                llevamos soluciones de clase mundial a empresas locales.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-100 rounded-3xl p-10 hover:shadow-xl transition-all">
              ...
              <h2 className="font-display text-2xl font-extrabold text-gray-950 tracking-tighter mb-4 uppercase">
                Misión
              </h2>
              <p className="text-gray-500 leading-relaxed">
                Proveer soluciones tecnológicas innovadoras y escalables que
                optimicen la operatividad y competitividad de nuestros clientes,
                con un equipo comprometido con la excelencia técnica y el
                servicio al cliente.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-3xl p-10 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-500 leading-relaxed">
                Ser la empresa de tecnología de referencia en la región Caribe
                colombiana para 2030, reconocida por la calidad de nuestras
                soluciones, la solidez de nuestro equipo y el impacto positivo
                en la digitalización empresarial regional.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {valores.map((v, i) => (
              <div
                key={i}
                className="group p-7 border border-gray-100 rounded-2xl hover:border-verde-200 hover:bg-verde-50 transition-all"
              >
      ...
      <section className="py-16 text-center bg-white">
        <div className="mx-auto max-w-xl px-6">
          ...
          <p className="text-gray-500 mb-8">
            Estamos listos para escuchar tu proyecto y proponerte la mejor
            solución.
          </p>
          <Link
            href="/contacto"
